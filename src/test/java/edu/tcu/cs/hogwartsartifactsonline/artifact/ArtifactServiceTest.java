...
class ArtifactServiceTest {
    ...
    */
    ...
    void testUpdateSuccess(){
        ...
        update.setDescription("A new description."); // Just changed the description
        update.setImageUrl("ImageUrl");

        // update is really two steps, find and then save
        given(artifactRepository.findById("1250808601744904192")).willReturn(Optional.of(oldArtifact));
        given(artifactRepository.save(oldArtifact)).willReturn(oldArtifact); // Once we save it, it will have the new values
        // When
