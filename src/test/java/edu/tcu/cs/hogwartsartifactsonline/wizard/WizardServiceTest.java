...
class WizardServiceTest {
    ...
    void testAssignArtifactSuccess(){
        ...
        w3.setId(3);
        w3.setName("Neville Longbottom");
        given(this.artifactRepository.findById("1250808601744904192")).willReturn(Optional.of(a)); // Find that the artifact exists and the wizard exits
    ...
    void testAssignArtifactErrorWithNonExistentWizardId(){
        ...
        given(this.artifactRepository.findById("1250808601744904192")).willReturn(Optional.of(a)); // Find that the artifact exists and the wizard exits
        given(this.wizardRepository.findById(3)).willReturn(Optional.empty()); // No such wizard
    ...
    void testAssignArtifactErrorWithNonExistentArtifactId(){
       ...
       // Do no need anything since we look for artifact
