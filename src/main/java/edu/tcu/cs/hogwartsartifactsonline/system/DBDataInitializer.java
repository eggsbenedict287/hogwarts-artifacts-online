...
import org.springframework.boot.CommandLineRunner; // implements a run method, gets called when springboot is started
import org.springframework.stereotype.Component;

@Component // Spring will now treat it as a bean
public class DBDataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        artifactRepository.save(a6); // Since this artifact doesn't have a wizard, we must add it directly
